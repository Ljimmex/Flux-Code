...
export function AntigravityIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 15" fill="none" className={className}>
      <mask id="antigravity__mask0_111_52" style={{ maskType: 'alpha' as any }} maskUnits="userSpaceOnUse" x="0" y="0" width="16" height="15">
