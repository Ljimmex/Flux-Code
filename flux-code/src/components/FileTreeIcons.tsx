...
export const BashIcon = memo(function BashIcon({ size = 16, className }: IconProps) {
  return (
...
export const CIcon = memo(function CIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const CppIcon = memo(function CppIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" fillRule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clipRule="evenodd"/>
    </Svg>
...
export const CssIcon = memo(function CssIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" opacity=".2"/>
...
export const DatabaseIcon = memo(function DatabaseIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const DefaultFileIcon = memo(function DefaultFileIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const GitIcon = memo(function GitIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const GoIcon = memo(function GoIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const HtmlIcon = memo(function HtmlIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" opacity=".2"/>
...
export const ImageIcon = memo(function ImageIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const JavaScriptIcon = memo(function JavaScriptIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" opacity=".2"/>
...
export const JsonIcon = memo(function JsonIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const PythonIcon = memo(function PythonIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const RubyIcon = memo(function RubyIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
export const TypeScriptIcon = memo(function TypeScriptIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" opacity=".2"/>
      <path fill="currentColor" d="M8.1 9.64h.95c.04.62.28.76 1.28.76s1.2-.14 1.2-.85c0-.66-.2-.85-1.2-1.07-1.79-.38-2.18-.7-2.18-1.86C8.15 5.3 8.54 5 10.31 5c1.67 0 2.04.26 2.07 1.42h-.95c-.02-.43-.23-.53-1.1-.53-1 0-1.22.14-1.22.74 0 .52.22.7 1.24.92 1.76.38 2.15.73 2.15 2 0 1.44-.4 1.75-2.24 1.75-1.8 0-2.18-.3-2.15-1.66m-3 1.57V5.99H3.5v-.9h4.21v.9H6.1v5.22z"/>
...
export const YamlIcon = memo(function YamlIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path fill="currentColor" d="M8 15c-5.76 0-7-1.24-7-7V2a1 1 0 0 1 1-1h6c5.77 0 7 1.24 7 7s-1.24 7-7 7" opacity=".2"/>
      <path fill="currentColor" d="M4.5 4h1.18l1.5 3.5L8.68 4h1.17l-2.1 4.5v3.5H6.25v-3.5zM9.5 4h1v8h-1z"/>
    </Svg>
  );
});

export const ZipIcon = memo(function ZipIcon({ size = 16, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
...
/** Map a filename to its icon component */
